...
//----------------------------------------------------------------------------------------------------	
	...
	{
	$objUser->deleteTemorderReorder($_GET['nid']);
	}
	...
	{		
			...
			for($i=1; $i<=$counter; $i++)
				{ 
					...
					$objUser->deleteTemorderReorder($_POST['chkbox'.$i]);
					}
				}
	}

//............................................
		$result1		=	$objUser->getAllTepmorderreorder();	
		$pgObj->SetNavigationalLinksNew($result1);
		$result		 	=	$objUser->getAllTepmorderreorder($LIMIT);
//............................................
	...
	$show		 =	$objUser->showTempOrder_reorder($result);

//------------------------html---------------------------------------

include("html/reodrproces.html");
