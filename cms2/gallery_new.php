...
<td width="810" valign="top" class="rightside"><h2>Gallery</h2>
...
<table cellpadding='0' cellspacing='0' class='list' width='90%'>
 ...
 <!-- <td class='header' width='171' align="center">Link </td>
  ...
  <td class='header' width='171' align="center">Gallery Images</td>
...
<?php $id = $_GET['group_id']; ?>
<?php $sqlSlider = mysql_query("select * from sliders_new where group_id='".$id."'");
...
$slider = mysql_fetch_object($sqlSlider);
 ...
 <tr>
   <td class="item" style="padding-left:" 0px;="" align="center"><?=$slider->group_id?></td>
    ...
    <!--<td class="item" nowrap="nowrap" align="center"><a href="bannermanage_new.php?action=up&amp;nid=<?=$slider->s_id?>" onclick="return delete_pro();">Delete</a></td>-->
</tr>
