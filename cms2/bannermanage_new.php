...
$slider = mysql_fetch_object($sqlSlider);
 ...
 <tr>
   <td class="item" style="padding-left:" 0px;="" align="center"><?=$slider->group_id?></td>
    ...
    <td class="item" nowrap="nowrap" align="center"><a href="gallery_new.php?group_id=<?=$slider->group_id?>">View By group ID </a>| <a href="gallery_management.php?action=up&amp;nid=<?=$slider->s_id?>" onclick="return delete_pro();">Delete</a></td>
</tr>
