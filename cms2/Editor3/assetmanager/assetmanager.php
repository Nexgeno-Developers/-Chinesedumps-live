...
//$imagepath="http://localhost/hair/adminimages/";

$imagepath="http://www.conceptbeans.com/projects/testcerts/adminimages/";
          ...
          echo "<input type=hidden name=inpFile".$nIndex." id=inpFile".$nIndex." value=\"".$imagepath.$sCurrent_virtual."\">";
...
function doOk()
  ...
  if(navigator.appName.indexOf('Microsoft')!=-1)
    ...
    window.returnValue=document.getElementById("inpSource").value;// window.returnValue=inpSource.value;
