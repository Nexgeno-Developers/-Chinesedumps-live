...
//--------------------Creat objects---------------------------
	...
	$sInfo = mysql_query("select * from sliders_new where s_id ='".$_GET['ven_id']."'");
	$fetchSlider = mysql_fetch_array($sInfo);

	if(isset($_POST['Submit']) && $_POST['Submit']  == "Submit")
	{

		$totalReport = mysql_query("select * from sliders_new ");
		...
		mysql_query("update sliders_new set type='".$spram[9]."', s_image='".$spram[2]."', s_alt='".$spram[3]."', s_link='".$spram[4]."' where s_id='".$_POST["sid"]."'");
